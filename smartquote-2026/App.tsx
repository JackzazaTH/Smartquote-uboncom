...
const App: React.FC = () => {
  ...
  return (
    <div className="h-screen w-full flex items-center justify-center p-4 md:p-6 overflow-hidden relative print:p-0 print:block print:h-auto print:overflow-visible">
        {showFormatModal && <FormatSelectionModal onSelect={handleSelectFormat} />}

        {/* --- MAIN WORKSPACE --- */}
        <div className="w-full h-full max-w-[1920px] grid grid-cols-1 lg:grid-cols-[480px_1fr] gap-6 relative print:block print:w-full print:h-full print:max-w-none">
            ...
            {/* RIGHT PANE: PREVIEW */}
            <div className="hidden lg:flex flex-col relative rounded-[2rem] bg-slate-900/50 backdrop-blur-sm border border-white/10 shadow-inner overflow-hidden print:flex print:visible print:static print:bg-transparent print:border-none print:shadow-none print:rounded-none print:overflow-visible print:w-full print:h-full">
                {/* Toolbar */}
                ...
                {/* Canvas */}
                <div className="flex-1 overflow-y-auto p-12 flex justify-center items-start print:p-0 print:overflow-visible custom-scrollbar print:block print:w-full print:h-full">
                    <div className="bg-white shadow-2xl print:shadow-none transition-transform duration-300 origin-top scale-[0.9] xl:scale-100 a4-page relative ring-1 ring-black/5 print:transform-none print:ring-0 print:m-0 print:w-full">
                        <Preview 
