...
export const Preview: React.FC<PreviewProps> = ({ company, customer, document, items, totals, floatingImages, onUpdateFloatingImage, onRemoveFloatingImage }) => {
  ...
  const renderContent = () => {
    if (!isGov) {
      ...
      // Increased pb to 36 to ensure signature is not cut off
      return (
          ...
          <div className="p-8 pb-36 pt-8 flex flex-col h-full flex-grow relative">
              ...
              <div className="mt-auto">
                  ...
                  <div className="flex justify-between px-6 text-black align-bottom">
                      <div className="text-center relative"><div className="w-48 mb-2 mx-auto"></div><p className="text-[10px] font-bold text-gray-700 print:text-black">ผู้อนุมัติสั่งซื้อ / Customer Signature</p><div className="mt-2 text-[10px] text-gray-900 print:text-black">.......................................................</div></div>
                      <div className="text-center relative"><div className="relative mb-2 mx-auto w-48 h-8 flex items-end justify-center"><div className="border-b border-gray-300 w-full"></div></div><p className="text-xs font-bold text-black">({document.signerName || document.preparedBy || '.......................................'})</p><p className="text-[10px] font-bold text-brand-600 mt-0.5 print:text-black">{document.signerPosition || 'ผู้มีอำนาจลงนาม'}</p><div className="mt-1 text-[10px] text-gray-900 print:text-black">วันที่ {formatDateTH(document.date)}</div></div>
                  </div>
              </div>
          </div>
          </div>
      ...
      // Increased pb to 36 to ensure footer is not cut off
      return (
