          ...
          <div className="p-8 pb-4 pt-8 mb-3 flex flex-col h-full flex-grow relative">
              ...
              <div className="flex gap-4 mb-4 text-[11px]">
                  ...
                  <div className="w-[40%] bg-gray-50/50 rounded-lg p-0 border border-gray-200 overflow-hidden shadow-sm text-[11px] print:shadow-none print:bg-gray-50">
                      <div className="grid grid-cols-[100px_1fr] gap-y-0 h-full">
                          ...
                          <div className="p-2 text-gray-900 font-medium border-b border-r border-gray-200 flex items-center print:text-black">วันที่</div><div className="p-2 border-b border-gray-200 flex items-center text-gray-900 print:text-black">{document.date}</div>
                          ...
                          <div className="p-2 text-gray-900 font-medium border-b border-r border-gray-200 flex items-center print:text-black">ใช้ได้ถึงวันที่</div><div className="p-2 border-b border-gray-200 flex items-center text-brand-600 font-bold print:text-black">{document.dueDate}</div>
              ...
              <table className="w-full text-[11px] border-collapse rounded-t-lg overflow-hidden table-fixed">
                  ...
                  <tr className="bg-brand-600 text-white text-center font-bold h-9 shadow-sm print:bg-gray-800 print:text-white">
                      <th className="p-1 w-[4%] rounded-tl-lg border-r border-brand-500 print:border-gray-700">#</th>
              ...
              <div className="mt-auto">
                  <div className="flex gap-4 items-stretch mb-6">
                      <div className="w-[60%] flex flex-col gap-3">
                          <div className="flex-grow border border-gray-200 rounded-lg p-3 bg-white shadow-sm flex flex-col justify-between print:shadow-none print:border-gray-300">
                              <div><h3 className="font-bold text-brand-600 text-xs mb-1.5 flex items-center gap-2">📝 หมายเหตุ (Remarks)</h3><div className="text-[10px] text-gray-900 whitespace-pre-wrap leading-relaxed pl-2 border-l-2 border-brand-200 py-0.5 print:text-black">{document.remarks || "-"}</div></div>
                  ...
                  <div className="flex justify-between px-6 text-black align-bottom pb-4">
                      ...
                      <div className="text-center relative"><div className="relative mb-2 mx-auto w-48 h-8 flex items-end justify-center"><div className="border-b border-gray-300 w-full"></div></div><p className="text-xs font-bold text-black">({document.signerName || document.preparedBy || '.......................................'})</p><p className="text-[10px] font-bold text-brand-600 mt-0.5 print:text-black">{document.signerPosition || 'ผู้มีอำนาจลงนาม'}</p><div className="mt-2 text-[10px] text-gray-900 print:text-black">วันที่ {document.date}</div></div>
                  </div>
              </div>
          </div>
          </div>
          ...
          <div className="p-8 flex flex-col h-full relative">
            ...
            <div className="flex border border-black mb-1">
              ...
              <div className="w-[40%] p-2">
                  <table className="w-full text-[12px] leading-tight"><tbody>
                        <tr><td className="w-[110px] align-top font-bold py-0.5 print:text-black">วันที่</td><td className="align-top py-0.5 print:text-black">{document.date}</td></tr>
                        ...
                        <tr><td className="align-top font-bold py-0.5 print:text-black">ยืนราคาถึงวันที่</td><td className="align-top py-0.5 print:text-black">{document.dueDate}</td></tr>
            ...
            <div className="mt-auto">
                ...
                <div className="flex justify-between mt-6 px-8 pb-4">
                    ...
                    <div className="text-center relative w-1/3"><div className="border-b border-black mb-1 mx-auto w-4/5"></div><p className="text-[12px] font-bold mb-1 print:text-black">({document.signerName || '...........................................'})</p><p className="font-bold text-[12px] print:text-black">{document.signerPosition || 'ผู้มีอำนาจลงนาม'}</p><div className="mt-2 text-[11px] print:text-black">วันที่ {document.date}</div></div>
                </div>
            </div>
          </div>
        </div>
