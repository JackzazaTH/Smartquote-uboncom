...
export const Preview: React.FC<PreviewProps> = ({ company, customer, document, items, totals, floatingImages, onUpdateFloatingImage, onRemoveFloatingImage }) => {
  ...
  const renderContent = () => {
    if (!isGov) {
      ...
      return (
          <div className="w-[210mm] h-[297mm] bg-white text-black text-sm leading-relaxed font-sans relative overflow-hidden flex flex-col mx-auto">
          <div className="p-8 pb-24 pt-8 flex flex-col h-full flex-grow relative">
              {/* Header */}
              ...
              <div className="mt-auto">
                  <div className="flex gap-3 items-stretch mb-2">
                      <div className="w-[60%] flex flex-col gap-2">
                          <div className="flex-grow border border-gray-200 rounded-lg p-2 bg-white shadow-sm flex flex-col justify-between print:shadow-none print:border-gray-300">
                              <div><h3 className="font-bold text-brand-600 text-xs mb-1 flex items-center gap-2">📝 หมายเหตุ (Remarks)</h3><div className="text-[10px] text-gray-900 whitespace-pre-wrap leading-relaxed pl-2 border-l-2 border-brand-500 py-0.5 print:text-black">{document.remarks || "-"}</div></div>
                              <div className="my-1.5 border-t border-gray-100"></div>
                              <div><h3 className="font-bold text-brand-600 text-xs mb-1.5 flex items-center gap-2">🏦 ชำระเงินโอนเข้าบัญชี (Bank Details)</h3><div className="text-[11px] text-gray-900 pl-2 print:text-black"><p className="mb-0.5"><span className="font-semibold text-gray-900 print:text-black">{company.bankName}</span> สาขา {company.bankBranch}</p><p className="mb-1">ชื่อบัญชี <span className="font-semibold text-gray-900 print:text-black">{company.name}</span></p><div className="flex items-center gap-2 bg-gray-50 p-1 rounded border border-gray-100 w-fit print:bg-transparent print:border-gray-300"><span className="font-medium text-gray-900 text-[10px] print:text-black">เลขที่บัญชี</span><span className="font-bold text-base text-brand-600 tracking-wide font-mono leading-none print:text-black">{company.bankAccount}</span></div></div></div>
                          </div>
                      </div>
                      <div className="w-[40%] flex flex-col">
                          <div className="bg-white rounded-lg border border-gray-200 overflow-hidden shadow-sm h-full flex flex-col print:shadow-none print:border-gray-300">
                              <div className="p-2 space-y-1.5 text-xs flex-grow">
                                  ...
                                  <div className="mt-2 bg-[#FFF7ED] border border-[#FED7AA] rounded-md p-1.5 text-center relative overflow-hidden print:bg-orange-50 print:border-orange-200"><div className="absolute top-0 left-0 w-1 h-full bg-brand-400"></div><span className="font-bold text-brand-800 text-[10px] print:text-black">({totals.grandTotalText})</span></div>
                              </div>
                              <div className="bg-gradient-to-br from-brand-500 to-brand-600 p-3 text-white relative overflow-hidden print:bg-brand-600 print:text-white print:border-t print:border-brand-600">
                  ...
                  <div className="flex justify-between px-6 text-black align-bottom">
                      <div className="text-center relative w-1/3">
                          <div className="h-8"></div>
                          <p className="text-[10px] font-bold text-gray-700 print:text-black">ผู้อนุมัติสั่งซื้อ / Customer Signature</p>
                          <div className="mt-4 border-b border-dotted border-gray-400 w-full h-1 mx-auto print:border-black"></div>
                      </div>
                      <div className="text-center relative w-1/3">
                          <div className="relative mb-2 mx-auto w-full h-8 flex items-end justify-center">
                              <div className="border-b border-gray-300 w-full print:border-black"></div>
                          </div>
                          <p className="text-xs font-bold text-black">({document.signerName || document.preparedBy || '.......................................'})</p>
                          <p className="text-[10px] font-bold text-brand-600 mt-0.5 print:text-black">{document.signerPosition || 'ผู้มีอำนาจลงนาม'}</p>
                          <div className="mt-1 text-[10px] text-gray-900 print:text-black">วันที่ {formatDateTH(document.date)}</div>
                      </div>
                  </div>
              </div>
          </div>
      ...
      return (
        <div className="w-[210mm] h-[297mm] bg-white text-black text-[13px] leading-relaxed font-sans mx-auto flex flex-col overflow-hidden">
          <div className="p-8 pb-24 flex flex-col h-full relative">
            <div className="flex justify-between items-start mb-3">
            ...
            <div className="flex border border-black mb-1">
              ...
              <div className="w-[40%] p-2">
                  <table className="w-full text-[12px] leading-tight"><tbody>
                        ...
                        {document.deliveryDate && (<tr><td className="align-top font-bold py-0.5 print:text-black">วันที่ส่งสินค้า</td><td className="align-top py-0.5 print:text-black">{document.deliveryDate}</td></tr>)}
            ...
            <div className="mt-auto">
                ...
                <div className="flex justify-between mt-1 px-8">
                    <div className="text-center relative w-1/3"><div className="border-b border-black mb-6 mx-auto w-4/5"></div><div className="text-left text-[11px] ml-[10%] mb-2 print:text-black">ประทับตรา_<br/>ตัวบรรจง (...........................................)</div><p className="font-bold text-[12px] print:text-black">ผู้สั่งซื้อสินค้า</p><div className="mt-2 text-[11px] text-left ml-[10%] print:text-black">ตำแหน่ง...........................................<br/>วันที่ ...........................................</div></div>
                    <div className="text-center relative w-1/3"><div className="border-b border-black mb-6 mx-auto w-4/5"></div><p className="text-[12px] font-bold mb-1 print:text-black">({document.signerName || '...........................................'})</p><p className="font-bold text-[12px] print:text-black">{document.signerPosition || 'ผู้มีอำนาจลงนาม'}</p><div className="mt-2 text-[11px] print:text-black">วันที่ {formatDateTH(document.date)}</div></div>
                </div>
            </div>
          </div>
        </div>
