        ...
        <div className="p-8 pb-4 pt-10 flex flex-col h-full flex-grow relative">
            ...
            <table className="w-full text-[11px] border-collapse rounded-t-lg overflow-hidden table-fixed">
                ...
                <tr className="bg-brand-600 text-white text-center font-bold h-9 shadow-sm print:bg-gray-800 print:text-white">
                    ...
                    <th className="p-1 w-[10%] border-r border-brand-500 print:border-gray-700">จำนวน</th>
                    <th className="p-1 w-[10%] border-r border-brand-500 print:border-gray-700">หน่วย</th>
                    <th className="p-1 w-[15%] border-r border-brand-500 print:border-gray-700">ราคา/หน่วย</th>
                    <th className="p-1 w-[15%] rounded-tr-lg">จำนวนเงิน</th>
                </tr>
                </thead>
                <tbody>
                    ...
                    <div className="w-[40%] flex flex-col">
                        <div className="bg-white rounded-lg border border-gray-200 overflow-hidden shadow-sm h-full flex flex-col print:shadow-none print:border-gray-300">
                            ...
                            <div className="bg-gradient-to-br from-brand-500 to-brand-600 p-4 text-white relative overflow-hidden print:bg-brand-600 print:text-white print:border-t print:border-brand-600">
                                {/* Hide decorative circles in print to prevent rasterization */}
                                <div className="absolute -top-6 -right-6 w-16 h-16 bg-white opacity-10 rounded-full print:hidden"></div>
                                <div className="absolute bottom-2 right-12 w-8 h-8 bg-white opacity-5 rounded-full print:hidden"></div>
                                
                                <div className="flex flex-col justify-between h-full relative z-10 gap-1">
                                    <div className="flex justify-between items-end">
                                        <div className="flex flex-col">
                                            {/* Remove drop-shadow in print to force vector text */}
                                            <span className="font-bold text-base leading-tight drop-shadow-sm print:drop-shadow-none print:filter-none">จำนวนเงินรวมทั้งสิ้น</span>
                                            <span className="text-[9px] opacity-90 uppercase font-medium tracking-widest mt-0.5">Grand Total</span>
                                        </div>
                                        <span className="font-bold text-2xl leading-none tracking-tight drop-shadow-md print:drop-shadow-none print:filter-none">{formatCurrency(totals.grandTotal)}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
           ...
           <table className="w-full border-collapse border border-black text-[12px] table-fixed">
              <thead>
                 <tr className="text-center font-bold">
                    ...
                    <th className="border border-black p-1 w-[10%]">จำนวน</th>
                    <th className="border border-black p-1 w-[10%]">หน่วยนับ</th>
                    <th className="border border-black p-1 w-[15%]">ราคาต่อหน่วย</th>
                    <th className="border border-black p-1 w-[20%]">ราคารวม</th>
                 </tr>
              </thead>
              <tbody>
                 {items.map((item, index) => {
