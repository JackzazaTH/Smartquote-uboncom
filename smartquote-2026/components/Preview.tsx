...
export const Preview: React.FC<PreviewProps> = ({ company, customer, document, items, totals }) => {
  ...
  // Adjusted for compact fitting on A4
  const minRows = 10;
        ...
        <div className="p-8 pb-4 pt-10 flex flex-col h-full flex-grow relative">
            ...
            <div className="flex justify-between items-start mb-6">
                ...
                <div className="text-right">
                    <div className="bg-brand-50 text-brand-600 px-5 py-1 rounded-l-full inline-block mb-1 shadow-sm border border-brand-100 border-r-0">
            ...
            <div className="flex gap-4 mb-4 text-[11px]">
                {/* Customer Box */}
                <div className="w-[60%] bg-white rounded-lg p-3 border border-gray-200 shadow-sm">
                ...
                {/* Document Info Box */}
                <div className="w-[40%] bg-gray-50/50 rounded-lg p-0 border border-gray-200 overflow-hidden shadow-sm text-[11px]">
            ...
            <table className="w-full text-[11px] border-collapse rounded-t-lg overflow-hidden">
                <thead>
                <tr className="bg-brand-600 text-white text-center font-bold h-9 shadow-sm">
                    <th className="p-1 w-[5%] rounded-tl-lg border-r border-brand-500">#</th>
                    <th className="p-1 w-[15%] border-r border-brand-500">Part Number</th>
                    <th className="p-1 text-left border-r border-brand-500 pl-3">รายละเอียดสินค้า / Description</th>
                    <th className="p-1 w-[8%] border-r border-brand-500">จำนวน</th>
                    <th className="p-1 w-[8%] border-r border-brand-500">หน่วย</th>
                    <th className="p-1 w-[12%] border-r border-brand-500">ราคา/หน่วย</th>
                    <th className="p-1 w-[10%] border-r border-brand-500">ส่วนลด</th>
                ...
                {items.map((item, index) => {
                    ...
                    <tr key={item.id} className="align-top text-black border-b border-gray-100 hover:bg-orange-50/20 transition-colors">
                            ...
                            {item.imageUrl && (
                                <div className="mt-1">
                                    <img 
                                        src={item.imageUrl} 
                                        alt="Product" 
                                        style={{ height: (item.imageHeight || 100) * 0.8 }}
                                        className="object-contain max-w-full rounded-sm border border-gray-100 p-0.5"
                                    />
                                </div>
                            )}
                        </td>
                        ...
                        <td className={`border-x ${borderColor} p-2 text-right text-red-500`}>{discountText !== '-' ? discountText : <span className="text-gray-300">-</span>}</td>
            ...
            <div className="mt-auto">
                <div className="flex gap-4 items-stretch mb-6">
                    ...
                    <div className="w-[60%] flex flex-col gap-3">
                        <div className="flex-grow border border-gray-200 rounded-lg p-3 bg-white shadow-sm flex flex-col justify-between">
                            {/* Remarks */}
                            <div>
                            ...
                            <div>
                                ...
                                <div className="text-[11px] text-gray-700 pl-2">
                                    ...
                                    <div className="flex items-center gap-2 bg-gray-50 p-1.5 rounded border border-gray-100 w-fit">
                        ...
                        <div className="bg-[#FFF7ED] border border-[#FED7AA] rounded-lg p-2 text-center shadow-sm relative overflow-hidden">
                    ...
                    <div className="w-[40%] flex flex-col">
                        <div className="bg-white rounded-lg border border-gray-200 overflow-hidden shadow-sm h-full flex flex-col">
                            ...
                            <div className="bg-gradient-to-br from-brand-500 to-brand-600 p-4 text-white relative overflow-hidden">
      ...
      <div className="p-8 flex flex-col h-full relative">
        ...
        <div className="flex justify-between items-start mb-3">
           ...
           <div className="w-[150px] flex-shrink-0">
               {company.logoUrl && <img src={company.logoUrl} className="w-full object-contain max-h-20" alt="logo" />}
           </div>
           {/* Company Info Right */}
