  ...
  const renderContent = () => {
    if (!isGov) {
      ...
      return (
          ...
          <div className="p-8 pb-12 pt-8 flex flex-col h-full flex-grow relative">
      ...
      return (
        <div className="w-[210mm] h-[297mm] bg-white text-black text-[13px] leading-relaxed font-sans mx-auto flex flex-col overflow-hidden">
          <div className="p-8 pb-12 flex flex-col h-full relative">
            <div className="flex justify-between items-start mb-3">
            ...
            <div className="mt-auto">
                ...
                <div className="flex justify-between mt-4 px-8 pb-4">
