        ...
        <div className="p-8 pb-4 pt-10 flex flex-col h-full flex-grow relative">
            ...
            <table className="w-full text-[11px] border-collapse rounded-t-lg overflow-hidden">
                ...
                <tr className="bg-brand-600 text-white text-center font-bold h-9 shadow-sm">
                    ...
                    <th className="p-1 w-[10%] border-r border-brand-500">รูปภาพ</th>
                        ...
                        <td className={`border-x ${borderColor} p-1 text-center align-middle`}>
                            {item.imageUrl ? (
                                <img 
                                    ...
                                    className="object-contain max-w-full mx-auto rounded-sm"
                                />
                            ) : null}
                        </td>
        ...
        <div className="flex-grow">
           <table className="w-full border-collapse border border-black text-[12px]">
              ...
              <tbody>
                 ...
                 <tr className="border-t border-black"><td colSpan={7}></td></tr>
              </tbody>
           </table>
        </div>
