      ...
      >
        <div className="space-y-4">
            <button 
                ...
                className={`w-full py-4 border-2 border-dashed rounded-xl flex items-center justify-center gap-2 font-bold transition-all mb-4 group hover:scale-[1.01] ${
                  items.length >= 5 
                ...
                <div className="mb-5 p-4 bg-orange-50 border border-orange-200 rounded-xl shadow-sm animate-in zoom-in-95 duration-200">
                    <div className="flex gap-3">
                        ...
                        <div className="flex-1 pt-0.5">
                            <h4 className="font-bold text-orange-800 text-sm mb-1">จำกัด 5 รายการ (Limit 5 items)</h4>
            ...
            {items.map((item, index) => (
                <div key={item.id} className="bg-white rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-all duration-300 hover:scale-[1.01] overflow-hidden group">
                    {/* Header Row */}
            ...
            {items.length === 0 && (
                <div className="text-center py-12 bg-gray-50/50 rounded-xl border-2 border-dashed border-gray-200 flex flex-col items-center justify-center text-gray-400 group cursor-pointer hover:bg-gray-50 hover:border-brand-200 transition-all hover:scale-[1.01]" onClick={addItem}>
      ...
      >
        <div className="grid grid-cols-1 gap-4 text-sm">
             ...
             <InputGroup label="โลโก้บริษัท">
                 {company.logoUrl && (
                    <div className="shrink-0 p-4 bg-gray-50 rounded-xl border